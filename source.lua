--[[
    Do not steal this code or I will take you down for copyright.
]]
...
local alternativeSS = {
	...
	harked = "https://raw.githubusercontent.com/avoidjayson/backdoor/web/harkedSS"
}
...
local function Main()
	...
	StarterGui:SetCore(
		"SendNotification",
		{
			...
			Duration = 5,
			Text = "Join Jayson's discord server",
			Callback = Bindable
		}
	)
